...
gboolean
gst_wl_display_get_color_transfer_function_supported (GstWlDisplay * self,
...
gboolean
gst_wl_display_get_color_primaries_supported (GstWlDisplay * self,
    uint32_t primaries)
{
  GstWlDisplayPrivate *priv = gst_wl_display_get_instance_private (self);
  guint i;
...
gboolean
gst_wl_display_get_color_coefficients_supported (GstWlDisplay * self,
